{ ... }:
{
  ...
  boot.initrd.luks.devices."luks-c3cd1e3f-45ef-4009-bdf4-73dfab099aaa".crypttabExtraOpts = ["fido2-device=auto"];
  ...
  boot.initrd.luks.devices."luks-93e2669c-48fc-47e6-8a36-ed31eeda94b3".crypttabExtraOpts = ["fido2-device=auto"];
